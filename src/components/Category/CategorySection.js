...
const CategorySection = () => {
    const { data: categories, status } = useQuery("categories", getCategories);

    return (
        <div className="min-w-320 s:w-full sm:w-full md:w-full xl:w-full mx-auto flex flex-col text-center mb-5">
            <div className="bg-category bg-no-repeat bg-cover bg-center">
                <div className="flex flex-wrap justify-center flex-col p-4 pt-0">
